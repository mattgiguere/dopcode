pro dop_bstar_psf, yrmo=yrmo, tag=tag, mode=mode, smooth=smooth, plot=plot, hdcopy=hdcopy, $
	psfmod=psfmod
...
xh=strpos(cdbf_mid,'HR') 
vdnm_mid='vd'+tag+strmid(cdbf_mid,xh,strlen(cdbf_mid)-xh)
