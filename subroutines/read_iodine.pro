...
;Example:
; read_iodine,'ctiov1f','pnnl',40,5800.,5802.,wvac,tran
...
;Directory where iodine spectrum is saved.
  case cell of
    'lick': dir = '/mir1/iodine/'
    'aat' : dir = '/mir2/iodine/'
;    'keck': dir = '/mir3/iodine/'
    'keck': dir = '/home/fischer/dop2/atlas/'
    'ctio': dir = '/tous/mir7/atlas/'
    'ctiov1': dir = '/tous/mir7/atlas/'
    'ctiov1f': dir = '/tous/mir7/atlas/'  ; JV's fixed version
    else: diag, -1, 'unknown iodine cell name: ' + cell
  endcase

if cell eq 'ctiov1' or cell eq 'ctiov1f' then iodine_temps = 40.0
...
;Restore entire iodine spectrum, unless it is already in common block.
  ...
  if iodine_cell ne lab then begin
    ;file = dir + 'iodine_' + cell + '_' + lab + '.dat'
    file = dir + 'ctiov1f_pnnl_red5'+'.dat'
